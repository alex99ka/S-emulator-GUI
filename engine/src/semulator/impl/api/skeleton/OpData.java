...
public enum OpData {
    ...
    QUOTE("QUOTE",5,0,OpType.SYNTHETIC), // degree value will be calculated later
    JUMP_EQUAL_FUNCTION("JUMP_EQUAL_FUNCTION",6,0,OpType.SYNTHETIC); // degree value will be calculated later
